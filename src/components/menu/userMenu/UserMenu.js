...
const UserMenu = () => {
  return (
    <nav className={style()}>
      <ul>
        <li><NavLink to="/events/add" exact="false">Dodaj urlop</NavLink></li>
        <li><NavLink to="/events" exact="false">Moje urlopy</NavLink></li>
        <li><NavLink to="/events/waiting" exact="false">Urlopy oczekujące</NavLink></li>
